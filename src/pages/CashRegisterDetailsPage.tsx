...
export default function CashRegisterDetailsPage({ currentId }: { currentId?: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Grupo Novo: Indicadores do Período e Vendas de Hoje */}
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card className="border border-border rounded-2xl shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="space-y-1">
                <p className="text-xs text-muted-foreground font-medium uppercase">Vendas Hoje</p>
                <p className="text-xl font-bold text-foreground">{currencyFormatter.format(totalVendasDia)}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border rounded-2xl shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              <div className="p-3 rounded-xl text-sky-600 bg-sky-100">
                <ShoppingBag className="h-5 w-5" />
              </div>
              <div className="space-y-1">
                <p className="text-xs text-muted-foreground font-medium uppercase">Pedidos Hoje</p>
                <p className="text-xl font-bold text-foreground">{ordersToday.length}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border rounded-2xl shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="space-y-1">
                <p className="text-xs text-muted-foreground font-medium uppercase">Ticket Médio (Hoje)</p>
                <p className="text-xl font-bold text-foreground">{currencyFormatter.format(ticketMedioHoje)}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border rounded-2xl shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              <div className="p-3 rounded-xl text-amber-600 bg-amber-100">
                <Package className="h-5 w-5" />
              </div>
              <div className="space-y-1">
                <p className="text-xs text-muted-foreground font-medium uppercase">Itens Vendidos Hoje</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card className="border border-border rounded-2xl shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="space-y-1">
                <p className="text-xs text-muted-foreground font-medium uppercase">Pedidos Totais (Caixa)</p>
                <p className="text-xl font-bold text-foreground">{pedidosTotaisCaixa}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border rounded-2xl shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="space-y-1">
                <p className="text-xs text-muted-foreground font-medium uppercase">Ticket Médio (Caixa)</p>
                <p className="text-xl font-bold text-foreground">{currencyFormatter.format(ticketMedioCaixa)}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-border rounded-2xl shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="space-y-1">
                <p className="text-xs text-muted-foreground font-medium uppercase">Itens Vendidos (Caixa)</p>
                <p className="text-xl font-bold text-foreground">{itensVendidosCaixa}</p>
              </div>
            </CardContent>
          </Card>
        </div>
